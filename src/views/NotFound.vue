<template>
  <div class="p-6">
    ...
    >
      ...
      <g class="cls-4">
        <g id="Layer_2" data-name="Layer 2">
          ...
          <path
            class="cls-6"
            d="M342.65,599.74S356.47,665.9,406.56,651,432,573.13,432,573.13Z"
          />
          <path
            class="cls-2"
            d="M458.35,233,168.82,319.14a35.66,35.66,0,0,0-24,44.35L222,622.81l111.08-33a6.58,6.58,0,0,1,8.35,5q.49,2.5,1.24,5c8,26.79,34.45,42.56,59.13,35.21s38.24-35,30.26-61.82c-.5-1.66-1.06-3.29-1.7-4.87a6.58,6.58,0,0,1,4.27-8.72l111.08-33.06Z"
    ...
    <div class="px-4 flex flex-col justify-center items-center">
      <h3 class="font-semibold text-lg text-center dark:text-white lg:text-3xl">
        Ops... Página não encontrada!
      </h3>
      <p class="mt-2 mb-4 dark:text-white lg:text-xl lg:mt-6 lg:mb-10">
