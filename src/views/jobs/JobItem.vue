<template>
  <li
    class="w-11/12 px-4 py-2 border rounded-md flex flex-col items-center shadow-sm hover:shadow-md transition-all transform hover:-translate-y-0.5 hover:scale-105 hover:border-gray-300 md:flex-row"
  >
